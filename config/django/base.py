...
DIGITAL_PAYMENT_PROVIDER_PENDING_HOLD_SECONDS = env.int(
    "DIGITAL_PAYMENT_PROVIDER_PENDING_HOLD_SECONDS", default=1800
)
DIGITAL_PAYMENT_VERIFICATION_PENDING_HOLD_SECONDS = env.int(
    "DIGITAL_PAYMENT_VERIFICATION_PENDING_HOLD_SECONDS", default=1800
)
DIGITAL_PAYMENT_REVIEW_HOLD_SECONDS = env.int(
    "DIGITAL_PAYMENT_REVIEW_HOLD_SECONDS", default=86400
)
DIGITAL_PAYMENT_ABANDONMENT_SECONDS = env.int(
    "DIGITAL_PAYMENT_ABANDONMENT_SECONDS", default=86400
)
DIGITAL_PAYMENT_NOMINAL_EXPIRY_RENEWAL_SECONDS = env.int(
    "DIGITAL_PAYMENT_NOMINAL_EXPIRY_RENEWAL_SECONDS", default=1800
)
DIGITAL_PAYMENT_FINALIZATION_RETRY_SECONDS = env.int(
    "DIGITAL_PAYMENT_FINALIZATION_RETRY_SECONDS", default=300
)
DIGITAL_PAYMENT_FINALIZATION_RETRY_MAX_SECONDS = env.int(
    "DIGITAL_PAYMENT_FINALIZATION_RETRY_MAX_SECONDS", default=3600
)
FINANCIAL_RUNTIME_VERIFICATION_LEASE_SECONDS = env.int(
    "FINANCIAL_RUNTIME_VERIFICATION_LEASE_SECONDS", default=60
)
FINANCIAL_RUNTIME_RECOGNITION_LEASE_SECONDS = env.int(
    "FINANCIAL_RUNTIME_RECOGNITION_LEASE_SECONDS", default=60
)
FINANCIAL_RUNTIME_RETRY_BASE_SECONDS = env.int(
    "FINANCIAL_RUNTIME_RETRY_BASE_SECONDS", default=30
)
FINANCIAL_RUNTIME_RETRY_MAX_SECONDS = env.int(
    "FINANCIAL_RUNTIME_RETRY_MAX_SECONDS", default=900
)
FINANCIAL_RUNTIME_MAX_BATCH_SIZE = env.int(
    "FINANCIAL_RUNTIME_MAX_BATCH_SIZE", default=100
)
CHEATSGAME_RUNTIME_ENVIRONMENT = env(
    "CHEATSGAME_RUNTIME_ENVIRONMENT", default="development"
).strip().lower()
FINANCIAL_CERTIFICATION_PROVIDER_ENABLED = env.bool(
    "FINANCIAL_CERTIFICATION_PROVIDER_ENABLED", default=False
)
FINANCIAL_CERTIFICATION_SECRET = env(
    "FINANCIAL_CERTIFICATION_SECRET", default=""
)
FINANCIAL_CERTIFICATION_ALLOWED_HOSTS = env.list(
    "FINANCIAL_CERTIFICATION_ALLOWED_HOSTS", default=[]
)
FINANCIAL_CERTIFICATION_ACCOUNT_KEY = env(
    "FINANCIAL_CERTIFICATION_ACCOUNT_KEY", default="staging-certification"
)
FINANCIAL_CERTIFICATION_OWNER_KEY = env(
    "FINANCIAL_CERTIFICATION_OWNER_KEY", default="cheats-game-staging"
)
...
MIDDLEWARE = [
    ...
    'cheatgame.core.crawler.CrawlerExclusionMiddleware',
